#!/usr/bin/python
# insert channels from channel_id-list.txt
# channel_id-list.txt のチャンネル一覧から全てのチャンネルを登録する
...
for cid in channel_id_list:
    print("insert https://www.youtube.com/channel/{}".format( cid.rstrip('\n')))
    try:
        add_subscription(youtube, cid.rstrip('\n'))
